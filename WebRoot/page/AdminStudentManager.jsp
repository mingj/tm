...
<html>
  <head>
    <title><s:text name="COMMON_TITLE"></s:text>-学生录入管理</title>
  ...
  <body>
    <table id="dg" class="easyui-datagrid"
            ...
            url:'${pageContext.request.contextPath}/main/queryStudentDataGridByJson.do',method:'post',toolbar:'#dg-toolbar'">
        <thead>
            <tr>
                <th data-options="field:'name',width:100,align:'center'">姓名</th>
                <th data-options="field:'code',width:100,align:'center'">学号</th>
            </tr>
        </thead>
    </table>
    <div id="dg-toolbar" style="padding:5px;height:auto">
        <div>
            <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-add'" onclick="operation('add','${pageContext.request.contextPath}/main/doAddStudentCode.do')"><s:text name="BUTTON.ADD"></s:text></a>
            <a href="#" class="easyui-linkbutton" data-options="plain:true,iconCls:'icon-cancel'" onclick="operation('del','${pageContext.request.contextPath}/main/doDeleteStudentCode.do')"><s:text name="BUTTON.DEL"></s:text></a>
        </div>
        <div>
           	学号:
           		<input type="text" id="query_code" name="studentVo.code" style="width:100px">
	    ...
	    <form id="dlgFm" action="" method="post">
	    	<table style="border: 1">
          	 	<tr>  
	                ...
	                <td align="left">
	                	<input id="dlg_id" type="hidden" maxlength="256" style="width:150px;" name="studentVo.id" />
	                	<input id="dlg_code" type="text" maxlength="256" style="width:150px;" name="studentVo.code"/>
	                </td>  
	            </tr>  
           </table>
	    </form>
